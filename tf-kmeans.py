...
V = np.array((X, Y), dtype=np.float64).T
...
clusters = TFKMeansCluster(V, 3)


plt.plot(X[0:500], Y[0:500], 'x')
plt.plot(X[500:1000], X[500:1000], 'x')
plt.plot(X[1000:1500], Y[1000:1500], 'x')
plt.axis('equal')
plt.show()
